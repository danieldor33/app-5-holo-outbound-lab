...
st.caption(
    ...
    "(1) Red Lane – Review and optimize your active hypotheses and cadences. "
    "Refine what’s working, adjust what’s not, and create new ones to test.\n\n"
    "(2) Orange Lane – Audit your accounts and contacts. Identify opportunities to develop "
    "account-led hypotheses and corresponding cadences.\n\n"
